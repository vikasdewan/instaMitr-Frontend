...
export function BottomBar() {
  ...
  useEffect(() => {
    if (likeNotiList.length > 0 && !showPopover) dispatch(setlikeNotiList([]));
              ...
              <Popover className="left-0">
                <PopoverTrigger asChild>
                  <div>
                    <Button
                      size="icon"
                      className=" bg-red-500 hover:bg-red-500 rounded-full h-5 w-5 absolute top-1 md:bottom-6  md:left-6"
                    >
                      {likeNotiList?.length}
                    </Button>
                  </div>
