...
const FollowersFollowingDialog = ({ type = "followers", userProfile, onClose }) => {
  const dialogRef = useRef(null);
  const usersList = type === "followers" ? userProfile?.followers : userProfile?.following;
  ...
  return (
    <div className="fixed inset-0 z-50 bg-transparent bg-opacity-60 flex justify-center items-center">
      <div ref={dialogRef} className="bg-gray-900 text-white p-4 rounded-xl w-80 max-h-[80vh] overflow-y-auto shadow-xl">
